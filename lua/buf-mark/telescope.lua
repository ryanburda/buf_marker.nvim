...
T.load_worktree = function(opts)
  ...
  pickers.new(opts, {
    prompt_title = "Load buf-marks from worktree",
...
T.load_project = function(opts)
  ...
  pickers.new(opts, {
    prompt_title = "Load buf-marks from working directory",
...
T.unload_worktree = function(opts)
  opts = opts or {}
  ...
  pickers.new(opts, {
    prompt_title = "Unload buf-marks from worktree",
    ...
    attach_mappings = function(prompt_bufnr)
      actions.select_default:replace(function()
        ...
        local selection = action_state.get_selected_entry()
        if selection then
          buf_mark.unload_marks(selection.value, { rebase = true })
        end
      end)
      return true
    end,
...
T.unload_project = function(opts)
  opts = opts or {}
  ...
  pickers.new(opts, {
    prompt_title = "Unload buf-marks from working directory",
    ...
    attach_mappings = function(prompt_bufnr)
      actions.select_default:replace(function()
        ...
        local selection = action_state.get_selected_entry()
        if selection then
          buf_mark.unload_marks(selection.value, { rebase = false })
        end
      end)
      return true
    end,
